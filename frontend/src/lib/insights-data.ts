...
export const INSIGHTS: InsightPost[] = [
  {
    slug: 'nj-prepayment-penalty-law-2026',
    title: 'New Jersey Just Changed the Game on Prepayment Penalties',
    excerpt: 'New Jersey\'s new prepayment penalty restrictions for commercial mortgages take effect in 2026. Here\'s what every CRE investor and broker needs to know.',
    category: 'Regulation',
    date: 'March 2026',
    image: 'https://images.unsplash.com/photo-1555848962-6e79363ec58f?w=800&h=500&fit=crop',
    content: `## New Jersey Just Banned Most Commercial Prepayment Penalties
...
This is a significant win for commercial real estate borrowers in New Jersey and sets a precedent that other states may follow.`,
  ...
  {
    slug: 'dscr-rates-tightening-q1-2026',
    ...
    content: `## DSCR Rates in Q1 2026: The Landscape
...
Don't wait for rates to come down. The deals that work today should be locked in. Focus on properties where the DSCR is 1.2 or higher at current rates, and make sure your insurance quote is current — stale insurance estimates are killing deals in underwriting.`,
  ...
  {
    slug: 'str-regulation-tracker-march-2026',
    ...
    content: `## STR Regulation Changes — March 2026
...
Before buying an STR investment property, verify the current and pending regulations in your target market. We maintain a regulation tracker across all 31 states where we lend — ask your 818 Capital advisor for the latest.`,
  ...
  {
    slug: '70-percent-rule-dead-2026',
    ...
    content: `## Why the 70% Rule No Longer Works
...
The bottom line: do the math every time. Rules of thumb lost people money in 2024 and they'll lose money in 2026.`,
  ...
  {
    slug: 'multifamily-cap-rates-q1-2026',
    ...
    content: `## Q1 2026 Multifamily Cap Rate Overview
