...
import { getInsightBySlug, getAllInsightSlugs, INSIGHTS } from '@/lib/insights-data';
    ...
    <>
      ...
      <section className="relative min-h-[350px] flex items-end overflow-hidden">
        ...
        <div className="relative mx-auto max-w-content px-6 py-12 w-full">
          ...
          <p className="mt-3 text-sm text-navy-200 font-body">{post.date}</p>
        </div>
      </section>
      ...
      <section className="bg-navy-50/50 py-12">
        <div className="mx-auto max-w-content px-6">
          <h2 className="section-heading mb-8">More Insights</h2>
          <div className="grid gap-6 md:grid-cols-3">
            {related.map((p) => (
              <Link key={p.slug} href={`/insights/${p.slug}`} className="group rounded-lg border border-navy-100 bg-white shadow-sm overflow-hidden hover:shadow-md transition">
